<div class="bg-white shadow p-4">
    <div class="flex justify-between">
        ...
        <a href="<?php echo e(route('transactions.create')); ?>" class="bg-blue-600 text-white p-1 hover:bg-blue-700 inline-block mb-2">
            + Transaksi Baru
        </a>
    </div>
            ...
            <?php else: ?>
                ...
                <tr class="border hover:bg-gray-100">
                    ...
                    <td class="py-2 border-x p-2 text-center">
                        <a href="<?php echo e(route('transactions.detail', ['id' => $product['id']])); ?>">Detail</a>
                    </td>
                </tr>
...
<?php /**PATH /home/kaspian/Project/laravel-practical-main/resources/views/transaction/index.blade.php ENDPATH**/ ?>